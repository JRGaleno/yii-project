 ...
 */
class studies extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_studies, name, code', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider('studies', array(
			'criteria'=>$criteria,
		));
	}
	 ...
	 * @return studies the static model class
	 */
